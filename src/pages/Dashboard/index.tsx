...
function useLatest14PolygonalData() {
  const [latest14Tasks] = useAtom(latest14DaysTasksAtom)
  if (isDev) return MOCK_POLYGONAL_DATA
...
const Index = () => {
  const polygonalData = useLatest14PolygonalData()
      ...
      <div className={classNames(s.content, 'flex flex-col flex-1 p-8')}>
        ...
        <div className="flex-1 overflow-auto">
          <div className={classNames(s.stats, 'flex')}>
            ...
            <div
              style={{ width: '160px' }}
              className={classNames('h-full rounded-xl shadow-sm cursor-pointer', s.statsRight)}
              onClick={onClickTodayProgress}
            >
