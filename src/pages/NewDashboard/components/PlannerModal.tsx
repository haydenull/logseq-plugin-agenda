  ...
  return (
    <>
      ...
      <FullScreenModal open={open} onClose={() => setOpen(false)}>
        <div className="w-screen h-full p-8 flex gap-3 overflow-auto bg-gray-50 pr-[330px]">
          {/* Overdue */}
          <div className="w-[281px] shrink-0 mt-2 flex flex-col">
          ...
          {cycles.map((cycle) => {
            ...
            return (
              <div key={cycle} className="w-[281px] shrink-0 mt-2 flex flex-col ">
                <div className="bg-gray-300 px-2 py-2 rounded-md">
                            ...
                            >
                              ...
                              >
                                <div onClick={() => setEditTaskModal({ open: true, task })}>
                                  ...
                                  <div
                                    className={cn('text-gray-600 my-0.5', { 'line-through': task.status === 'done' })}
                                  >
                                    {showTitle}
                                  </div>
                                  {task.project.isJournal ? null : (
